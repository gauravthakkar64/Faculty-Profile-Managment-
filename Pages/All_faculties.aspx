<%@ Page Language="C#" AutoEventWireup="true" CodeFile="All_faculties.aspx.cs" Inherits="All_faculties" %>
	...
	<div class="site_background_1">
        ...
        <!-- Header -->
            ...
            <section id="content" style="background-color:#4D5D65">
                  ...
                  <h4>Faculties Profiles<asp:Button ID="Button3" runat="server" CssClass="admin_btn2" Text="Blocked Faculties" OnClick="Button3_Click" /><hr /></h4>
       ...
       <asp:GridView ID="GridView1" runat="server" CssClass="grid" AutoGenerateColumns="false" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" Width="600px" AllowPaging="true" PageSize="8" CellSpacing="4" CellPadding="4">
            <Columns >
                ...
                <asp:BoundField DataField="Lname" HeaderText="City" />
            </Columns>
            <HeaderStyle  />
            <RowStyle   />
        </asp:GridView>
        <br />
        <asp:Button ID="Button1" runat="server" BackColor="#E7CEB6"  OnClick="btnDeleteRecord_Click" Text="Remove" CssClass="admin_btn1"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp
            &nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" BackColor="#E7CEB6" Text="Block" CssClass="admin_btn1" OnClick="Button2_Click" />
        <br />
    </div>
