        ...
        <!-- Header -->
            <header>
                ...
                <nav>
                    ...
                    <ul><li id="usermenu" runat="server"><a href="#">Welcome <asp:Label ID="fname" runat="server" Text="faculty"></asp:Label></a>
                        <ul>
                  ...
                  <ul class="my_menu">
                      <li class="current"><a href="Faculty_Home.aspx">Home</a></li>
                      <li><a href="Faculty_profile.aspx">Profile</a></li>
                      <li><a href="Faculty_notifications.aspx">Notifications</a></li>
                      <li><a href="Faculty_support.aspx">Support</a></li>
